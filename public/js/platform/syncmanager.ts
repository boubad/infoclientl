...
import {IInfoMessage,IObjectStore} from 'infodata';
//
...
import {SYNC_IN, SYNC_OUT, SYNC_DATABASE,DATABASE_NAME,
  ...
  SYNC_DENIED,SYNC_STARTED, SYNC_RESUMED} from '../data/infoconstants';
//
@autoinject
export class SynchroManager extends InfoRootElement {
  //
  ...
  public get sessionStore():IObjectStore {
    if ((this._store === undefined)|| (this._store === null)){
      this._store = new SessionStore();
    }
    return this._store;
  }
