...
import {RootConsultViewModel} from '../model/rootconsultmodel';
import {IElementDesc} from 'infodata';
//
export class BaseListComponent<T extends IElementDesc> extends BaseComponent<RootConsultViewModel<T>> {
    //
    constructor() {
        super();
    }
